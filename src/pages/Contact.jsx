    ...
    >
      ...
      <section className="pt-24 pb-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Get in touch for product enquiries, support, or partnerships.
          </motion.p>
        </div>
      </section>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition resize-none"
                      placeholder="Your message..."
                    />
                  </div>
                  <button
                    type="submit"
                    className="w-full py-4 bg-brand-500 text-white font-semibold rounded-xl hover:bg-brand-600 shadow-soft hover:shadow-glow transition-all duration-300"
                  >
                    Send Message
                  </button>
                </form>
            ...
            <div className="bg-white rounded-2xl shadow-soft p-6 border border-gray-100">
              ...
              <ul className="space-y-4 text-gray-600">
                <li className="flex items-start gap-3">
                  <span className="w-10 h-10 rounded-lg bg-brand-50 flex items-center justify-center text-brand-600 shrink-0">
                  ...
                  <div>
                    ...
                    <p>123 Industrial Area, City, State – 123456</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-10 h-10 rounded-lg bg-brand-50 flex items-center justify-center text-brand-600 shrink-0">
                  ...
                  <div>
                    ...
                    <a href="tel:+911234567890" className="hover:text-brand-600 transition-colors">
                      +91 123 456 7890
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@newgoldtech.com" className="hover:text-brand-600 transition-colors">
                      info@newgoldtech.com
                    </a>
                  </div>
                </li>
              </ul>
